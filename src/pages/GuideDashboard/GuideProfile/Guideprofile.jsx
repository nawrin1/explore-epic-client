...
const GuideProfile = () => {
    ...
    console.log(guide[0],"guide prof")
        ...
        <div className=" mx-4  ">
            ...
            <div className="mt-5 flex flex-col lg:flex-row md:flex-row justify-around">
                <div className="font-serif ">
                    ...
                    <p className="text-slate-700">{guide[0]?.education[0].degree}</p>
                    <p className="text-slate-700">{guide[0]?.education[0].school}</p>
                    <p className="text-slate-700">{guide[0]?.education[0].graduationYear}</p>

                </div>
                <div className="font-serif ">
                <h2 className="text-2xl font-semibold mb-3 mt-3">Work Experience--</h2>
                <p><span className="font-semibold">Company: </span>{guide[0]?guide.workExperience[0].company:''}</p>
                <p><span className="font-semibold">Position: </span>{guide[0]?guide.workExperience[0].position:""}</p>
                <p><span className="font-semibold">Duration: </span>({guide[0]?guide.workExperience[0].startDate:''})-({guide[0]?guide.workExperience[0].endDate:''})</p>
                <p className="">
                    <span className="font-semibold">Responsibilities:</span>
                    {guide[0]?.workExperience[0]?.responsibilities.map((item, idx) => (
            ...
            <div className="flex flex-col lg:flex-row md:flex-row justify-around font-serif">
                ...
                <p><span className="font-semibold">Phone: </span>{guide[0]?guide[0].phone:""}</p>
                <p><span className="font-semibold">Address: </span>{guide[0]?guide[0].address:""}</p>
